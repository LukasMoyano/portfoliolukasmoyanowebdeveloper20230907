  ...
  return (
    <main className=" text-white w-full grid gap-4">
      ...
      <section className="relative w-full">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 outline-dashed outline-2 w-3/5 h-20 bg-lime-400 opacity-100 flex items-center justify-center">
          <a
          ...
          >
            ...
            <span className="font-bold text-xl"> Space Curiosities- </span>
          </a>
        </div>
